...
Poly* addition(Poly* p1, Poly* p2)
{
    ...
    do
    {
        ...
        {
            added=insert(added, temp1->coeff, temp1->power);
            temp1=temp1->link;
            c1++;
        }
        else if(temp1->power<temp2->power)
        {
            added=insert(added, temp2->coeff, temp2->power);
            temp2=temp2->link;
            c2++;
        }
        else
        {
            added=insert(added, temp1->coeff+temp2->coeff, temp1->power); 
            temp1=temp1->link;
            temp2=temp2->link;
            c1++; c2++;
        }
...
Poly* subtraction(Poly* p1, Poly* p2)
{
    if(p1==NULL) return p2;
    if(p2==NULL) return p1;
    ...
    do
    {
        ...
        if(temp1->power>temp2->power)
        {
            subtract=insert(subtract, temp1->coeff, temp1->power);
            temp1=temp1->link;
            c1++;
        }
        else if(temp1->power<temp2->power)
        {
            subtract=insert(subtract, temp2->coeff, temp2->power);
            temp2=temp2->link;
            c2++;
        }
        else
        {
            subtract=insert(subtract, temp1->coeff-temp2->coeff, temp1->power); 
            temp1=temp1->link;
            temp2=temp2->link;
            c1++; c2++;
        }
...
Poly* multiplication(Poly* p1, Poly*p2)
{
    ...
    do
    {
        ...
        multi=addition(multi, tempMulti);
        temp1=temp1->link;
    }while(temp1!=p1);
...
int main()
{
    ...
    printf("\nAddition Result: \n");
    printPoly(addition(p1,p2));

    printf("\nSubtraction Result: \n");
    printPoly(subtraction(p1,p2));
